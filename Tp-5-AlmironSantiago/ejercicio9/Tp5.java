...
public class Tp5 {
    ...
    public static void main(String[] args) {
        System.out.println("=== PRUEBA DE RELACIONES CITA MÉDICA - PACIENTE - PROFESIONAL ===");

        // Crear objetos
        Paciente paciente = new Paciente("María González", "OSDE");
        Profesional profesional = new Profesional("Dr. Carlos López", "Cardiología");
        CitaMedica citaMedica = new CitaMedica("2024-03-15", "10:30", paciente, profesional);
        ...
        // Verificar relaciones unidireccionales
        ...
        // Demostrar que son asociaciones unidireccionales
        ...
        // Mostrar flexibilidad de las asociaciones unidireccionales
        ...
        Profesional profesional2 = new Profesional("Dra. Ana Martínez", "Pediatría");
        CitaMedica citaMedica2 = new CitaMedica("2024-03-16", "11:00", paciente2, profesional2);
        ...
        // Mostrar reutilización de pacientes y profesionales
        System.out.println("\n=== REUTILIZACIÓN DE PACIENTE Y PROFESIONAL ===");
        CitaMedica citaMedica3 = new CitaMedica("2024-03-17", "09:00", paciente, profesional2); // Mismo paciente, diferente profesional
        CitaMedica citaMedica4 = new CitaMedica("2024-03-18", "16:00", paciente2, profesional); // Diferente paciente, mismo profesional
